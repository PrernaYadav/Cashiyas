...
public class Weeklybaracno extends Fragment implements OnChartValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.weekly_bar_acno, container, false);
        exp = new Bankmessagedb(getActivity());

        recyclerView = (RecyclerView) rootView.findViewById(R.id.listweekacno);
        recyclerView.setHasFixedSize(true);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayoutManager.VERTICAL));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        weekspends = (TextView) rootView.findViewById(R.id.textweekacno);
        linearrecord = (LinearLayout)  rootView.findViewById(R.id.weeklinearacno);
        linearnorecord = (LinearLayout)  rootView.findViewById(R.id.weeklinear1acno);

        barChartt = (BarChart) rootView.findViewById(R.id.chartbarweekacno);
        sv = (EditText) rootView.findViewById(R.id.searchweekacno);
        ...
        Log.i("testX", "date " + s1 + s7);

//        SimpleDateFormat month_year = new SimpleDateFormat("MM");
//        month_name1 = month_year.format(cal.getTime());
//        Log.i("month", "" + month_name1);
    ...
    private void calculatenxtweek(String getdates) {
        ...
        Log.i("vtydfsuyu",""+s6+ ".." +""+s1 +".." +""+s2 +".." +""+s3 +".." +""+s4+ ".."+s5 + ".."+s7 );
        Log.i("vtydfsuyu",""+s7+ ".." +""+s1 +".." +""+s2 +".." +""+s3 +".." +""+s4+ ".."+s5 + ".."+s6 );
    ...
    private void calulateSavings() {
        ...
        for (int i = 0; i <= 6; i++) {
            ...
            Log.i("entriesssq", " xVals " + entries);

        }
        dataset1 = new BarDataSet(entries, "Weekly Spends");
        Log.i("broadingwwww", " dataset1 " + dataset1);
        ...
        for (int i = 0; i <= 6; i++) {
            ...
            Log.i("broadingssss", " labels " + labels);
        }
...
//        RefreshChart();
    ...
    private Float getdataday(String day) {
        String aa = day;
        float spnds = 0;
        selectQuery = "SELECT amount from trans_msg WHERE changdate='" + aa + "' AND type!='CREDITED.' AND type!='AVAILABLE BALANCE' AND nameofbank='"+accntname+"' AND accuntnumber='"+accntno+"'";
        Log.i("broadingsss1ddd", "inside list getALLRecords" + selectQuery);
    ...
    public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
        ...
        Intent ii = new Intent(getContext(), PieWeekacno.class);
        ii.putExtra("calling", category);
        ii.putExtra("number", accntno);
        ii.putExtra("name", accntname);
        startActivity(ii);
    }
