 ...
 */
public class Leadongoing extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.leadongoing, container, false);
    ...
    public class insertusermain extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            param.add(new BasicNameValuePair("open", UserInformation.userid));
...
//                    .show();
            ...
            adapter2 = new SimpleAdapter(getActivity(),list, R.layout.layout_sturcuture_leads, from, to);
            lv2.setAdapter(adapter2);

//            adapter2 = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1 ,s);
//            lv2.setAdapter(adapter2);
